...
<body>
 <div>
    ...
    <nav class=" navbar-inverse" style="background-color:rgb(44, 126, 194)">
        ...
        <div class="collapse navbar-collapse" id="myNavbar" style="font-size:18px;">
            <ul class="nav navbar-nav" role="tablist">
                ...
                <li class="nav-item"><a class="nav-link" href="login.jsp" target="iframe"
                        style="color: white">Login</a></li>
                  <li class="nav-item"><a class="nav-link" href="empregister.jsp" target="iframe"
                        style="color: white">Register</a></li> 
                   <li class="nav-item"><a class="nav-link" href="" target="iframe"
    ...
    <iframe src="home.jsp" id="iframe" name="iframe" style="width: 100%;height: 430px;border: none" target="_parent"></iframe>
