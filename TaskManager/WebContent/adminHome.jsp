        ...
        <div class="collapse navbar-collapse" id="myNavbar" style="font-size:18px;">
            <ul class="nav navbar-nav" role="tablist">
                <li class="nav-item"><a class="nav-link active" href="home.jsp" target="iframe"style="color: white">Home</a></li>
                  <li class="nav-item"><a class="nav-link" href="addTask.jsp" target="iframe"
                        style="color: white">Add Task</a></li>
                 ...
                 <li class="nav-item"><a class="nav-link" href="searchdailystatus.jsp" target="iframe"
                        style="color: white">TrackTask</a></li>
               <li class="nav-item"><a class="nav-link" href="viewworkingdays.jsp" target="iframe"
                        style="color: white">Tracking</a></li>
                <li class="nav-item"><a class="nav-link" href="viewdetails.jsp" target="iframe"
                        style="color: white">ProfileDetails</a></li>
                 <li class="nav-item"><a class="nav-link" href="logout.jsp" 
                        style="color: white" target="_parent">Logout</a></li>
            </ul>
        </div>
    </nav>
    <iframe src="" id="iframe" name="iframe" style="width: 100%;height: 430px;border: none"></iframe>
