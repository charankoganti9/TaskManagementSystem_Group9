...
<html lang="en">
  ...
  %>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <form action="dailystatus_action.jsp" method="post" target="_parent">
 ...
 %>
                    ...
                    <div class="form-group">
                        <label>Date (*)</label>
                        <input type="date" name="t2" autocomplete="off" placeholder="2019-06-24" min="2019-06-06" max="2019-10-30" class="form-control" required>
                    </div>
