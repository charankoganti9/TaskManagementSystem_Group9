    ...
    <nav class=" navbar-inverse" style="background-color:rgb(44, 126, 194)">
        ...
        <div class="collapse navbar-collapse" id="myNavbar" style="font-size:18px;">
            <ul class="nav navbar-nav" role="tablist">
                ...
                <li class="nav-item"><a class="nav-link" href="viewdaily_status.jsp" target="iframe"
                        style="color: white">Track Status</a></li>
                  <li class="nav-item"><a class="nav-link" href="searchdailystatus.jsp" target="iframe"
                        style="color: white">TrackEmployeeTask</a></li>      
                 <!--  <li class="nav-item"><a class="nav-link" href="viewacceptedinfo.jsp" target="iframe"
                   ...
                   <li class="nav-item"><a class="nav-link" href="viewsupervisorprofile.jsp" target="iframe"
                        style="color: white">View profile</a></li>
                         <li class="nav-item"><a class="nav-link" href="sviewtask.jsp" target="iframe"
                        style="color: white">View Task</a></li>
                          <li class="nav-item"><a class="nav-link" href="schangepwrd.jsp" target="iframe"
                        style="color: white">ChangePswrd</a></li>
                         <li class="nav-item"><a class="nav-link" href="sdaily_status.jsp" target="iframe"
                        style="color: white">Daily status</a></li>
                   <li class="nav-item"><a class="nav-link" href="viewworkingdays.jsp" target="iframe"
                        style="color: white">TrackingEmployee</a></li>
               <!--     <li class="nav-item"><a class="nav-link" href="vedetails.jsp" target="iframe"
                        style="color: white">Employee Details</a></li> -->
